...
const SITE_DATA = {
  ...
  ai: {
    ...
    replies: [
      ...
      'AI 正在偷懶摸魚中，請稍後再試……其實就算你稍後再試，我還是在摸魚。',
      '系統提示：本 AI 採用最新節能技術，當偵測到低質量問題時，會自動進入「已讀不回」的環保模式。',
      '這問題問得非常好，下次請千萬不要再問了。',
      '由於 API 額度不足，GPT-6-Astra reject to answer your question(s)',
      '恭喜解鎖隱藏成就：「在深夜對著假 AI 機器人發廢話」'
    ]
  },
